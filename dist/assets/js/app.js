...
(0, _jquery2.default)(document).ready(function () {
	(0, _jquery2.default)('a.work__reveal').click(function () {
		var url = (0, _jquery2.default)(this).find('img')[0].src;
		var img = (0, _jquery2.default)(this).html();
		if (_foundationSites2.default.MediaQuery.atLeast('medium')) {
			(0, _jquery2.default)('#element').foundation('open');
			(0, _jquery2.default)('.work__modal-img').html(img);
		} else {
			window.open(url, '_blank', '', '');
		}
	});
	(0, _jquery2.default)('ul.work__list li').each(function () {
		// Get the content
		var str = (0, _jquery2.default)(this).html();
		// Set the regex string
		var regex = /(https?:\/\/([-\w\.]+)+(:\d+)?(\/([\w\/_\.]*(\?\S+)?)?)?)/ig;
		// Replace plain text links by hyperlinks
		var replaced_text = str.replace(regex, "<a href='$1' target='_blank'>$1</a>");
		// Echo link
		(0, _jquery2.default)(this).html(replaced_text);
	});
});
