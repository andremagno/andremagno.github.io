...
(0, _jquery2.default)(document).ready(function () {
	...
	(0, _jquery2.default)(".horizontal").on('scroll', function () {
		var i = 0;
		(0, _jquery2.default)('.horizontal .project__link').each(function () {
			// Is this element visible onscreen?
			var visible = (0, _jquery2.default)(this).visible();

			// Set the visible status into the span.
			(0, _jquery2.default)(this).toggleClass('active', visible);

			if ((0, _jquery2.default)(this).is(':first-child')) {
				i = 0;
			}
			i++;
			(0, _jquery2.default)('.graph .bar:nth-child(' + i + ')').toggleClass('active', visible);
		});
	});
});
